...
export default function Projects() {
  return (
    <div>
      <div class='projects'>
        <h2>Portfolio Website</h2><hr class='hrr1'/><hr class='hrr1'/>
        <div>
          <ul>
        ...
        <h2>To-Do Website</h2><hr class='hrr1'/><hr class='hrr1'/>
        <div>
          <ul>
       ...
       <h2>Library Management System</h2><hr class='hrr1'/><hr class='hrr1'/>
        <div>
          <ul>
